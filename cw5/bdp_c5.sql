...
-- obiekt2 jako kolekcja linii i krzywych
...
-- obiekt2 jako figura
INSERT INTO obiekty VALUES(102, 'obiekt102', ST_BuildArea( ST_COLLECT(ARRAY['LINESTRING(10 6, 14 6)', 'CIRCULARSTRING(14 6, 16 4, 14 2)',
'CIRCULARSTRING(14 2, 12 0, 10 2)', 'LINESTRING(10 2, 10 6)', 'CIRCULARSTRING(11 2, 13 2, 11 2)']) )  );

SELECT ST_PERIMETER(geom), ST_AREA(geom) FROM obiekty WHERE id_ = 102;
